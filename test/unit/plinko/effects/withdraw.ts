...
export default function shouldBehaveLikePlay(): void {
  context("when playing Plinko", function () {
    beforeEach(async function () {
      ...
      // Grant the GAME_ROLE to the msg.sender
      ...
      // await this.contracts.jadeCoreBankroll.grantRole(0, await this.contracts.plinko.getAddress());
      await this.contracts.jadeCoreBankroll.grantRole(GAME_ROLE, await this.contracts.plinko.getAddress());

      const tx = await this.contracts.plinko.Plinko_Play(
        100,
      ...
      const multipliers = [
        ...
        [
          ...
          [
            52000, 8000, 1500, 1000, 300, 200, 50, 30, 20, 30, 50, 200, 300, 1000, 1500, 8000,
            52000,
    ...
    it("check fulfillRandomWords", async function () {
      ...
      await this.contracts.plinko.fulfillRandomWords(this.id, [
